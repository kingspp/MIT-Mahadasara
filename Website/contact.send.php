<?php
	...
	$send_name      = "Mahadasara 2015";		// Replace your name
	$send_title     = "Contact Form";		// Replace email sent title
...
//	$mail->SMTPSecure = "tls";   						// If you use gmail address, active this line
	...
	$mail->msgHTML("Selected type : ".$_POST["type"]."<br /><br />".$_POST["name"]." ".$_POST["email"]."<br />".$_POST["phone"]."<br />".$_POST["message"]);
